System.register(['angular2/core', '../services/users.service', 'angular2/http', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
            ...
            UsersComponent = (function () {
                ...
                UsersComponent.prototype.deleteUser = function (user) {
                    ...
                    if (confirm('Estás seguro de eliminar al usuario?')) {
                        ...
                        this._usersService.deleteUser(user.id).subscribe(null, function (err) {
